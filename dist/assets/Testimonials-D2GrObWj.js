const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/GlobeWrapper-DPsWe_bE.js","assets/vendor-rapier-BlGIw0Ig.js","assets/vendor-three-C9nf-1Xb.js","assets/vendor-react-Bkc4rGZb.js","assets/vendor-motion-DmjuJuG3.js","assets/index-bDyetWRE.js","assets/index-BC-7tCa1.css"])))=>i.map(i=>d[i]);
import { _ as k } from "./vendor-rapier-BlGIw0Ig.js";
import { u as N, c as S, j as e, m as u, A } from "./vendor-motion-DmjuJuG3.js";
import { a as o, __tla as __tla_0 } from "./vendor-react-Bkc4rGZb.js";
import { i as F, __tla as __tla_1 } from "./index-bDyetWRE.js";
import "./vendor-three-C9nf-1Xb.js";
let L;
let __tla = Promise.all([
    ...
    const C = o.lazy(()=>k(()=>import("./GlobeWrapper-DPsWe_bE.js").then(async (m)=>{
                await m.__tla;
                return m;
            }), __vite__mapDeps([0,1,2,3,4,5,6])).then((a)=>({
                default: a.GlobeWrapper
            }))), c = [
        {
            id: "c1",
            name: "Amara Okafor",
    ...
    L = function() {
        const a = o.useRef(null), [i, f] = o.useState(0), [g, y] = o.useState(!1), [v, b] = o.useState(!1), n = o.useRef(0), d = o.useRef(1), x = o.useRef(F()), h = o.useRef(null), { scrollYProgress: m } = N({
            target: a,
            offset: [
                "start start",
                "end end"
        ...
        S(m, "change", (s)=>{
            const t = Math.min(c.length - 1, Math.floor(s * c.length));
            t !== n.current && (d.current = t > n.current ? 1 : -1, n.current = t, f(t));
        }), o.useEffect(()=>{
            const s = a.current;
            if (!s) return;
            const t = new IntersectionObserver(([p])=>{
                const l = p.isIntersecting;
                y(l), l && !x.current && b(!0);
            }, {
                threshold: .05
            });
        ...
        const w = (s)=>{
            h.current = s.touches[0].clientX;
        }, j = (s)=>{
            if (h.current === null) return;
            const t = s.changedTouches[0].clientX - h.current;
            if (h.current = null, Math.abs(t) < 40) return;
            const p = t < 0 ? 1 : -1, l = Math.max(0, Math.min(c.length - 1, n.current + p));
            l !== n.current && (d.current = p, n.current = l, f(l));
        }, r = c[i];
      ...
      `
                ...
                e.jsx("div", {
                    ref: a,
                    className: "relative h-[200vh] sm:h-[250vh] lg:h-[300vh] bg-[#13082A]",
                    children: e.jsxs("div", {
                        className: "sticky top-0 h-screen flex flex-col justify-center overflow-hidden border-t border-white/10 pt-16 pb-4 md:pt-20 md:pb-0",
                        children: [
                            e.jsxs("div", {
                                className: "text-center mb-4 sm:mb-5 md:mb-8 px-4 md:px-8",
                                children: [
                                    e.jsx("div", {
                                        ...
                                        children: e.jsx("span", {
                                            ...
                                            children: "Human Stories, Proven Results"
                                        })
                                    }),
                                    e.jsx("h2", {
                                        ...
                                        children: "Impact Across the Continent"
                                    })
                                ]
                            }),
                            e.jsxs("div", {
                                className: "max-w-[1400px] mx-auto w-full flex-1 min-h-0 flex gap-4 sm:gap-6 px-3 sm:px-5 md:px-8",
                                children: [
                                    e.jsxs("div", {
                                        ...
                                        children: [
                                            ...
                                            e.jsxs("div", {
                                                className: "relative w-[340px] h-[340px] flex-shrink-0",
                                                children: [
                                                    e.jsxs("div", {
                                                    ...
                                                    e.jsx("div", {
                                                        className: "absolute inset-[24px] rounded-full overflow-hidden bg-[#1A1040]",
                                                        children: v && e.jsx(o.Suspense, {
                                                            fallback: null,
                                                            children: e.jsx(C, {
                                                                scrollYProgress: m,
                                                                isVisible: g
                                            ...
                                            e.jsx("div", {
                                                className: "z-10 relative text-center mb-4",
                                                children: e.jsxs("p", {
                                    ...
                                    e.jsxs("div", {
                                        ...
                                        children: [
                                            e.jsx("div", {
                                                ...
                                                style: {
                                                    perspective: x.current ? void 0 : "1000px"
                                                },
                                                children: e.jsx(A, {
                                                    custom: d.current,
                                                    mode: "popLayout",
                                                    children: e.jsx(u.div, {
                                                        ...
                                                        children: e.jsxs("div", {
                                                            className: "relative flex flex-col gap-4 md:gap-6 overflow-hidden",
                                                            children: [
                                                                e.jsx("div", {
                                                                ...
                                                                e.jsxs("div", {
                                                                    className: "flex items-center gap-3 md:gap-4 mt-auto pt-2",
                                                                    children: [
                                                                        e.jsx("div", {
                                            ...
                                            e.jsxs("div", {
                                                className: "relative z-20 shrink-0 border-t border-white/10 bg-[#1A1040]",
                                                children: [
                                                    e.jsxs("div", {
                                                        className: "flex sm:hidden items-center justify-between px-4 py-3 gap-3",
                                                        children: [
                                                            e.jsxs("div", {
                                                                className: "flex items-center gap-1.5 min-w-0",
                                                                children: [
                                                                    e.jsx("img", {
                                                                        src: `https://flagcdn.com/20x15/${r.countryCode.toLowerCase()}.png`,
                                                                        width: 20,
                                                                        height: 15,
                                                                        alt: r.country,
                                                            ...
                                                            e.jsx("div", {
                                                                ...
                                                                children: c.map((s, t)=>e.jsx("div", {
                                                                        className: "transition-all duration-300",
                                                                        style: {
                                                                            width: t === i ? 20 : 6,
                                                                            height: 4,
                                                                            borderRadius: 2,
                                                                            background: t === i ? "var(--color-secondary)" : "rgba(255,255,255,0.2)"
                                                                        }
                                                                    }, t))
                                                            })
                                                        ]
                                                    ...
                                                    e.jsx("div", {
                                                        ...
                                                        children: c.map((s, t)=>e.jsxs("div", {
                                                                ...
                                                                style: {
                                                                    border: t === i ? "1px solid var(--color-secondary)" : "1px solid rgba(255,255,255,0.1)",
                                                                    background: t === i ? "rgba(164,108,252,0.12)" : "transparent"
                                                                },
                                                                children: [
                                                                    e.jsx("img", {
                                                                    ...
                                                                    e.jsxs("span", {
                                                                        ...
                                                                        style: {
                                                                            fontFamily: "var(--font-stack-heading)",
                                                                            color: t === i ? "rgba(255,255,255,0.9)" : "rgba(255,255,255,0.55)"
                                                                        },
                                                                        children: [
                                                                            s.name.split(" ")[0],
                                                                            " · ",
...
export { L as Testimonials, __tla };
