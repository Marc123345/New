        ...
        <div className="relative">
          ...
          <button
            ...
            style={{
              ...
              border: "none",
              borderRadius: "50%",
              background: activeIndex === 0 ? "rgba(164,108,252,0.3)" : "#a46cfc",
              color: activeIndex === 0 ? "rgba(255,255,255,0.4)" : "#ffffff",
          ...
          <button
            ...
            style={{
              ...
              border: "none",
              borderRadius: "50%",
              background: activeIndex === SERVICES.length - 1 ? "rgba(164,108,252,0.3)" : "#a46cfc",
              color: activeIndex === SERVICES.length - 1 ? "rgba(255,255,255,0.4)" : "#ffffff",
