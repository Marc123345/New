  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {/* Contact Form */}
          <div ref={formRef} style={{ display: activeTab === "form" ? "block" : "none", minHeight: 400 }} />

          {/* AI Agent */}
          <div ref={agentRef} style={{ display: activeTab === "agent" ? "block" : "none", minHeight: 500, padding: "8px" }} />
        </motion.div>
      </div>
