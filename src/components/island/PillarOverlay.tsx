      ...
      {pillarIndex !== null && displayService && (
        ...
        >
          ...
          <motion.div
            ...
            transition={{ duration: 0.3 }}
            className="relative flex flex-col w-full max-w-4xl bg-[#0a0c10] rounded-2xl shadow-2xl overflow-hidden"
            style={{
          ...
          >
            ...
            <div className="absolute top-4 right-4 sm:top-6 sm:right-6 z-50">
              <button
                type="button"
                onClick={onClose}
                className="flex min-h-[44px] min-w-[44px] items-center justify-center rounded-full border border-white/20 bg-[#141820]/80 backdrop-blur-sm hover:bg-[#1e2430] transition-all text-white cursor-pointer active:scale-95 group shadow-lg"
              ...
              <div className="max-w-3xl mx-auto space-y-10 sm:space-y-12">
                ...
                {displayService?.image && (
                  ...
                  >
                    ...
                    <div
                      ...
                      style={{ background: `linear-gradient(to top, #0a0c10 0%, transparent 50%, ${accent.from}88 100%)` }}
                    />
                ...
                >
                  {displayService?.stats?.map((s: { value: string; label: string }, i: number) => (
                    <div
                      key={i}
                      className="p-4 sm:p-6 bg-[#080a0e] text-center relative overflow-hidden group transition-all duration-300 rounded-lg shrink-0"
                      style={{
                ...
                >
                  ...
                  <div className="grid md:grid-cols-2 gap-3 sm:gap-4">
                    {displayService?.whatWeDo?.map((item: string, i: number) => (
                      <div
                        key={i}
                        className="flex items-start sm:items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-[#0e1117] border rounded-lg transition-all duration-200"
