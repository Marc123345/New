...
export const brandLogos: string[] = [
  ...
  svgSquare(
    "#181717",
    `<path d="M50 20C33 20 20 33 20 50c0 13 9 25 21 29 2 0 2-1 2-2v-7s-9 2-11-4c0 0-2-4-4-5 0 0-2-2 0-2s3 0 5 3c2 4 7 3 9 2 0-2 1-3 2-4-7-1-14-3-14-14 0-3 1-6 3-8 0-1-1-4 0-9 0 0 3-1 9 3 3-1 5-1 8-1s6 0 8 1c6-4 9-3 9-3 1 5 1 8 0 9 2 2 3 5 3 8 0 11-7 13-14 14 1 1 2 3 2 6v9c0 1 1 2 2 2 12-4 21-16 21-29 0-17-13-30-30-30z" fill="#fff"/>`
  ),
  // TikTok
  svgSquare(
    "#010101",
  ...
  svgSquare(
    "#4285F4",
    `<path d="M50 38c5 0 8 2 10 4l7-7c-5-4-11-7-17-7-10 0-18 6-22 14l8 6c2-6 8-10 14-10z" fill="#EA4335"/>` +
      `<path d="M28 50c0-2 0-4 1-6l-8-6c-2 4-3 8-3 12s1 8 3 12l8-6c-1-2-1-4-1-6z" fill="#FBBC05"/>` +
      `<path d="M50 62c-6 0-12-4-14-10l-8 6c4 8 12 14 22 14 6 0 11-2 15-5l-8-6c-2 1-4 1-7 1z" fill="#34A853"/>` +
      `<path d="M72 50c0-2 0-3-1-5H50v10h12c-1 3-3 5-5 6l8 6c4-4 7-10 7-17z" fill="#4285F4"/>`
  ),
  // Reddit
  svgSquare(
    "#FF4500",
